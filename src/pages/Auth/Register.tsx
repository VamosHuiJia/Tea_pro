...
const RegisterPage = () => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            ...
            {/* Card chính - kích thước YÊU CẦU giống Login.tsx */}
            <div
            ...
            >
                {/* === BÊN TRÁI - FORM ĐĂNG KÝ (nền xanh đậm) === */}
                <div
                    className={`relative flex flex-col justify-center px-6 py-10 sm:px-10 sm:py-12 lg:px-12 lg:py-16 bg-p-900/90 backdrop-blur-md border-r border-white/5 lg:border-r-0`}
                >
                    {/* Nút đóng */}
                    <button
                        onClick={() => navigate("/")}
                    ...
                    <p className="mb-8 text-base leading-relaxed sm:text-lg text-white/70">
                        Khởi đầu niềm vui từ tách trà đầu tiên.<br />
                        Đăng ký để cùng Huy khám phá.
                    </p>
                    ...
                    >
                        <h1 className="text-amber-50">ĐĂNG KÝ</h1>
                    </button>
                ...
                <div className="relative hidden overflow-hidden lg:block">
                    ...
                    />
                    <div className="absolute z-20 text-right top-10 right-10">
