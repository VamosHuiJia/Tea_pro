            ...
            <div className="container relative m-20 text-center">
                ...
                <div className="flex flex-col items-center justify-center w-full gap-0 lg:gap-10 lg:flex-row">
                    ...
                    <div data-aos="zoom-in"
                        className="feature-card group bg-[url(/images/benefit_1.jpg)]">
                    ...
                    <div data-aos="zoom-in"
                        data-aos-delay="400"
                        className="order-first bg-p-50 feature-card lg:order-none lg:bg-transparent">
                        <div>
                    ...
                    <div data-aos="zoom-in"
                        data-aos-delay="100"
                        className="feature-card group bg-[url(/images/benefit_2.jpg)]">
                        <div className="feature-filter"></div>
                ...
                <div data-aos="zoom-in"
                    ...
                    {/* <!-- Holigon 4 --> */}
                    <div className="feature-card group bg-[url(/images/benefit_3.jpg)]">
                        <div className="feature-filter"></div>
                    ...
                    <div data-aos="zoom-in"
                        data-aos-delay="300"
                        className="feature-card group bg-[url(/images/benefit_4.jpg)]">
                        <div className="feature-filter"></div>
