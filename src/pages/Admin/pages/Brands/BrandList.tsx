...
export default function BrandList({
  ...
  return (
    <div className="rounded-[28px] border border-p-100 bg-white p-4 shadow-sm md:p-5">
        ...
        <table className="min-w-[1100px] w-full border-separate border-spacing-y-3">
          <thead>
            <tr className="text-left text-sm text-n-500">
              ...
              <th className="pb-2 font-medium">Tên thương hiệu</th>
          ...
          <tbody>
            {brands.map((brand) => (
              <tr key={brand.id} className="bg-p-50/55 text-sm text-n-700">
