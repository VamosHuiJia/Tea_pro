  ...
  return (
    <div className="rounded-[32px] border border-p-100 bg-white p-4 shadow-sm md:p-5">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-[1600px] w-full border-separate border-spacing-y-3">
          <thead>
            <tr className="text-left text-sm text-n-500">
              ...
              <th className="pb-2 font-medium">Quyền hạn</th>
              ...
              >
                ...
                <td className="px-4 py-4">
                  <div className="min-w-[220px]">
                    <p className="font-semibold text-n-800">{employee.fullName}</p>
